...
<body>
<section class="vh-200" style="background-color: #82dfe4;">
	<div class="text-end">
      ...
      <div class="col-12 col-lg-9 col-xl-7">
        <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
          <div class="card-body p-4s p-md-5">
				<h2 class="text-center"><span style="font-family: 'Lucida Console';">Registro de </span><span class="text-success"  style="font-family: 'Times New Roman';">ECO</span><span  style="font-family: 'Lucida Console';">RESCATE</span></h2>
				<hr class="mb-4">
				...
				<div class="row">
					...
					<div class="form-group">
						...
						<form:input path="razonSocial" class="form-control form-control-lg"
					...
					<div class="col-md-6 mb-4 mt-4">
						...
						<form:input path="direccion" class="form-control form-control-lg"
